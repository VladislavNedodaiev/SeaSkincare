...
class VacationRequestController
{
	...
	public function getVacationRequestsByUserIDStatus($userID, $status) {
		...
		return $this->vacationRequestService->getVacationRequestsByUserIDStatus($userID, $status);
	...
	public function getVacationRequestsByBusinessID($businessID) {
		...
		return $this->vacationRequestService->getVacationRequestsByBusinessID($businessID);
	...
	public function getVacationRequestsByBusinessIDStatus($businessID, $status) {
		...
		return $this->vacationRequestService->getVacationRequestsByBusinessIDStatus($businessID, $status);
