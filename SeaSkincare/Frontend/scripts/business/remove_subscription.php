...
$url = 'https://sea-skincare-1577376592545.appspot.com/Backend/API/Subscription/Delete.php';
...
if ($response->status == "SUCCESS") {
	...
	$_SESSION['msg']['text'] = getLocalString('remove_subscription', 'SUCCESS');
	
} else {
	
	$_SESSION['msg']['type'] = 'alert-danger';
	$_SESSION['msg']['text'] = getLocalString('remove_subscription', 'UNKNOWN');
